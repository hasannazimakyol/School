sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("hnakyol/School/app", ".html");
		...
		return Opa5.extend("hnakyol.School.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["hnakyol/School/localService/mockserver"], function (mockserver) {
